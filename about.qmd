...
# How do gender, age, and marital status influence individuals' perceptions of their cooking skills?

```{=html}
 <iframe height="350" width="100%" frameborder="no" src="https://choiyunyu.shinyapps.io/scattergraph/"> </iframe>
```
```{=html}
 <iframe height="100" width="100%" frameborder="no" src="https://choiyunyu.shinyapps.io/density/"> </iframe>
```
```{<html}
<iframe height="400" width="100%" frameborder="no" src="https://choiyunyu.shinyapps.io/scattergraph/"> </iframe>
</html>}
